...
public final class ComandoFlex implements CommandExecutor, TabCompleter {
    ...
    /**
     * /flex power: el PODER de un jugador, en un menu.
     *
     * Es una cifra del JUGADOR, no de un mundo: lo que ha jugado (rango y habilidades)
     * mas lo que lleva puesto. Se ensena en un menu con el equipo delante, porque un
     * total a secas no dice que mejorar; el chat se reserva para presumir la cifra,
     * y eso se hace desde el boton del menu.
     */
